import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{r as t,o as p,c as o,a as n,b as s,d as l,f as i}from"./app-35f47e06.js";const r={},c=n("h1",{id:"vuepress",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#vuepress","aria-hidden":"true"},"#"),s(" VuePress")],-1),u=n("h2",{id:"简介",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#简介","aria-hidden":"true"},"#"),s(" 简介")],-1),d={href:"https://vuepress.vuejs.org/zh/",target:"_blank",rel:"noopener noreferrer"},v=n("br",null,null,-1),k=n("br",null,null,-1),m=n("br",null,null,-1),b=n("br",null,null,-1),g=i(`<h4 id="版本" tabindex="-1"><a class="header-anchor" href="#版本" aria-hidden="true">#</a> 版本</h4><blockquote><p>本文档使用v1.x版本<br><strong>前提条件</strong><br><strong>v1.x版本的 VuePress 需要 Node.js (opens new window)&gt;= 8.6</strong><br> v2.x的版本目前还不稳定</p></blockquote><h2 id="安装" tabindex="-1"><a class="header-anchor" href="#安装" aria-hidden="true">#</a> 安装</h2><p>1.创建并进入一个新目录</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>mkdir vuepress-starter
d vuepress-starter
